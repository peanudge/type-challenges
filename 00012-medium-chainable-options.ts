...
type Chainable<Options = {}> = {
  option<KeyType extends string, ValueType>(
    key: KeyType extends keyof Options ? ValueType extends Options[KeyType] ? never : KeyType : KeyType,
    value: ValueType extends keyof Options ? never : ValueType,
  ): Chainable<Omit<Options, KeyType> & {[k in KeyType] : ValueType}>;
